          ...
          <div className="relative">
            ...
            {[...Array(3)].map((_, i) => (
              <motion.div
                ...
                animate={{ rotate: 360 }}
                transition={{
                  duration: 2 + i * 0.4, // Faster start
                  repeat: Infinity,
                  ease: 'linear',
                }}
                className={`absolute inset-0 rounded-full border-2 border-dashed opacity-30 ${
                  i === 0
                    ? 'border-primary-400 w-32 h-32 -m-8'
                    : i === 1
                    ? 'border-secondary-400 w-48 h-48 -m-16'
              ...
              >
                <motion.div
                  ...
                  transition={{
                    duration: 1,
                    repeat: Infinity,
                    delay: i * 0.2, // Quicker pulses
                    ease: 'easeInOut',
                  }}
                  className={`absolute w-3 h-3 rounded-full ${
                    i === 0
                      ? 'bg-primary-400 top-0 left-1/2 -translate-x-1/2 -translate-y-1/2'
                      : i === 1
                      ? 'bg-secondary-400 top-1/2 right-0 translate-x-1/2 -translate-y-1/2'
            ...
            {[...Array(6)].map((_, i) => (
              <motion.div
                ...
                transition={{
                  duration: 1.2,
                  repeat: Infinity,
                  delay: i * 0.08, // More tightly packed wave
                  ease: 'easeInOut',
                }}
